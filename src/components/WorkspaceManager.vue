...
import { validateWorkspaceName, workspaceDirName } from "../composables/workspaceUi";
        ...
        <div class="ws-list">
          <div v-for="w in workspaces" :key="w.id" class="ws-row">
            <div class="ws-row-main">
              ...
              <span class="ws-row-path" :title="w.path || undefined">{{ workspaceDirName(w.path) }} · {{ w.conversation_count }} 会话</span>
            </div>
